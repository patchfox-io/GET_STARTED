...
Command to compile and build docker image. **NOTE** IF YOU ARE BEHIND A CORPORATE FIREWALL AND YOUR ORGANIZATION USES SOMETHING LIKE ZSCALER OR NETSKOPE THAT INTERCEPTS HTTPS TRAFFIC AND DOES FUN THINGS WITH CERTIFICATES YOU'LL NEED TO ENSURE THAT INTERNAL CERTIFICATE IS ASSOCIATED WITH THE DOCKER CONTAINER OR THINGS WILL FAIL. 
```
